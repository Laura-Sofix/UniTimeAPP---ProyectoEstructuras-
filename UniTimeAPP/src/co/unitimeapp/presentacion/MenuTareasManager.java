...
public class MenuTareasManager {
    ...
    public static void mostrarMenuTareas(Scanner scanner, GestorTareasEisenhower gestor, Calendario calendario) {
        ...
        while (!volver) {
            ...
            System.out.println("8. deshacer ultima tarea completada.");
            System.out.println("9. Ver recomendaciones de gestion del tiempo");
            System.out.println("10. Ver sitios web utiles para estudiantes");
            System.out.println("11. Acceder a juegos educativos");
            System.out.println("12. Calculadora de promedio");
            System.out.println("13. Gestion de sesiones Pomodoro");
